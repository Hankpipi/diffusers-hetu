...
################ Cosine Similarity ################
embeddings_1 = torch.load("texts_edit.pth", map_location=device) - torch.load("texts_origin.pth", map_location=device)
embeddings_2 = torch.load("hetu_edit.pth", map_location=device) - torch.load("hetu_origin.pth", map_location=device)
